...
Flowers and plants that are ornamental, wild, or cultivated in all 3 locations that can be used for medicinal, ornamentals, beauty products, and food.  
Mainly used for scent profiles used in cannon.

## Flowers

These are flowering plants with blossoms.  
🌾 Meadow ONLY flowers that need full sun.  
...
- Scent–Aesthetic
  - 🌾 Blue Flax (MAR-SEP)
  - Bluebells (APR-MAY)
  - Shooting Stars (APR-MAY)
  - 🌾 Paintbrush hybrids (APR-JUN)
  - 🌾 Indian Paintbrush (APR-JUN)
  - Blue-eyed Grass (APR–JUN)
  - Lupine (MAY-JUL)
  ...
  - 🌾 Harebells (JUN-SEP)
  - 🌾 Asters (tall prairie type — AUG-OCT)
  - 🌾 Goldenrod (AUG-OCT)
- Medicinal (Sahbobuk)
  ...
  - Penstemon (soothing poultice — MAY-JUL)
  - Honeysuckle (ritual use only — MAY–AUG)
  ...
  - Thistle (Cirsium — JUN–SEP)
  - Wild Lavender (calming, antiseptic — JUN–SEP)
  - Yarrow (JUN-SEP)
...
- Food / Edible Blossoms
  ...
  - Thistle (Cirsium — JUN–SEP)
  - Wild Garlic (JUN–SEP)
  - Wild Lavender (JUN–SEP)
  - Wild Onion (JUN–SEP)
  - Wild Bergamot (Bee Balm — JUL–AUG)

#### Areas Surrounding Meadow (Forest, River, Ridgeline)

All flowers listed under Meadow are included except those marked as Meadow ONLY.
...
- Medicinal (Sahbobuk)
  ...
  - Bigtooth Maple Blossoms (Acer grandidentatum — mild tonic, astringent — APR–MAY)
  - Oregon Grape Blossoms (APR–MAY)
  - Rocky Mountain Maple Blossoms (Acer glabrum — mild tonic, astringent — APR–MAY)
