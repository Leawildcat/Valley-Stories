...
- Family:  
  - Wife: Jillanna (d. 1998)
    - Nicknamed him Outlaw after Indian Outlaw came out
  - Sons:  
    - Jesse James
      - Born in 1994 (32–33)  
    - William "Billy" Bonny
...
- Role: Emotional parallel to Lea; Eldest sibling; Book 2 Arc;

- Traits:  
  - Quiet strength
  - Enforces manners / family etiquette
  - Deep grief over mother’s death as Mother's favorite
  - Protective and emotional caretaker of Kevin & Davey
  - Has déjà vu moments around Lea
  - former baseball player, now hs teacher & coach; lost his career due to shoulder and knee injury
...
- Role: Sensitive, intuitive; often overshadowed but foundational; Middle child and calm sibling between Aaron and Davey; Irish Twin to Davey Book 2 Arc
...
- Traits:
  ...
  - Has talent for understanding people's needs in tourism and vacations (Customer‑intuition talent / hospitality savant)
...
- Role: Youngest sibling; Irish twin dynamic with Kevin confirmed in‑story; emotional heart; Frank's best friend; instant soul‑recognition with Lea
...
- Traits:
  ...
  - Runt Gofer
  - Likes starting choas but panics when it gets out control becoming the victim
  - Slow pattern seer
  - Intuitive planner
...
- Flashback Age: 20's-30's

- Physical Traits:
  - Sam Elliot in Roadhouse adjacent
  - Build: Solid, grounded
  - Wildfire grin
  - Professional manicure (book joke)
  - Hair:Black, slightly wavy, currently supporting skullet look, grey sneaking in
  - Bushy eyebrows and mustache with more grey showing here
  - Sometimes sports beard
  - Eyes: Tawny brown
  - Height: 6'3"

- Role: Neighbor; recovering addict 15 years sober; Creative Engine; Book 1 Arc; Grew up across the street from the 3 brothers; promotions / advertising / production company
...
- Traits:
  ...
  - Tends to internalize and have conversations with himself
  - Bonds to Lea in a sibling but more way
  - Ancient old soul bond with Lea
  - Devoted to his wife and daughter
  - Forgets a lot even when making mental notes
  - First Valley Visit: Age ~35–36 (15 years before present timeline)
  - Easily embarrassed when Lynn or Lisa tease him
  - In the middle somewhere in a family of 6 kids
  - Italian heritage
...
- Age: 60 Born 1966
- Personal Traits:
  - Hair red like father's
  - Height: 5'7"
  - Short stature of mother with prominent Native American Traits, but stocky build of father. Think Scott Cann or Sean Astin
  - Hazel eyes

- River Holloway:
  - Died 2010 at 44 in accident with Lea's Son
  - Father of Lea’s niece
  - Guardian / Animal Form: Otter/River Otter

- Clay Holloway:
  - Baptist preacher
  - Rejects Native heritage
  - Thinks Jack and Lea are Devil's spawn
...
- Father Holloway
  ...
  - Blue Eyes
  - Height: 6'6"
  - Broad shoulders, linebacker build
  - Rancher
...
- Lisa Smith Callahan (Davey’s wife)
  - Age: ~47–48
  - Traits:
    - Almost Emerald green Eyes
    - Teasing, playful, sharp‑tongued in a loving way
    - Protective of Davey
    - Good‑natured instigator
    - Valley treats her like a mischievous auntie
    - Loves Frank like a brother and teases him relentlessly
    - Strong pack energy (fits Kaya’s painted dog guardian)
    - Has weak thought to speech filter
    - Named kids after Smith family from the movie Meet Me In St. Louis
    - Short 5'4"
    - Long loose brown curly hair
    - Full-figured a bit on heavy side, Jack describes it as robust figure
    - Obsessed withh wine
...
- Davey's Children:
  - Alonzo Callahan
    ...
    - Traits:
      - Energetic
      - Loud laugh
      - Loves challenges like his dad

  - Lonnie Callahan
    - Age: 9
    - Traits:
      - More cautious twin
      - Doesn't ask permission for personal comfort
      - Observant
  ...
  - Rose Ester Callahan
    ...
    - Traits:
      - Sweet, soft‑spoken
      - Attached to Lea instantly
      - Loves animals

### Marino Clan

- Lynn Marino (Frank’s wife)
  - Age: 45–48
  - Traits:
    - Willowy blonde
    - Hazel green eyes
    - 5'8-9"
    - Sharp, witty, playful
    - Teases Frank constantly
    - Grounded, emotionally stable
    - Strong maternal presence
    - Likes Lea's attitude toward men and her saying "testosterone poisoning"
    - Knows Lea is not a threat
    - Ticklish
    - Former waitress
    - Has crush on Jack
    - First to adopt Lea as a sister

- Samantha "Sam" Marino (Frank's Daughter)
  - Age: 10
  - Traits:
    - Bright, curious
    - Loves Selby and Snowball
    - Tickles
...
- Chooses Aaron
- Lea's core animal totem and animal form
- Chosen by Lea when she was just 5 when one bonked heads with her
- Traits:
  - Silent strength
  - Deep Intuition
  - Threshold‑walker
  - Protector of emotional truth
  - Moves between worlds quietly
  - Quiet observer

### Redtailed Hawk — Overseer

- Name: Aeyren (AYE‑ren)
- Chose Lea and was present at her birth
- Traits:
  - Messenger
  - Ancient
  - Neutral
  - Overseer for the Valley
  - Pattern guide and overall pattern seer

### Bear — Parenting & Friendships

- Cinnamon Toast (CT) or sometime MamaBear (MB)
- Choses Lea as a cub and later as and adult when Lea has her daughter
- Lea named her due to her coat looking like cinnamon toast
- Traits:
  - Maternal
  - Grounding
  - Ancestral wisdom
  - Emotional stabilizer
  - Protector of memory‑keepers
  - Recognizer of human bonds

### Painted Dog — Guide in happiness and reminding to take time out from the mundane to play

- Name: Kaya
- Chooses Davey
- Chose Lea at her work place and Lea relocated to her to the Valley
- Loves to taunt and try to 'eat' Jack
- In a relationship with Selby and spends time at Frank's house
- Afraid of thunderstorms
- Origin from Africa to USA unknown
- Traits:
  - African Painted dog with round ears
  - Expressive face and has tongue out a lot
  - Caliche tan coat with red clay highlights and black spots that look like paint splatter
  - Soft wiry fur
  - Joy
  - Play
  - Mischief
  - Community
  - Fierce loyalty
  - Chaos‑starter, chaos‑fixer
  - Easily distracted (SQUIRREL!)

### Wolf — The Mother

- Chooses Kevin
- Identity: Jack & Lea’s mother orignal core animal totem and form
- Only core guardian not a permanent resident and didn't choose Lea as a permanent guide
- Traits:
  - Protector
  - Generational memory
  - Pack loyalty
  - Pack alpha mentality
  - Fierce love
...
- Snowball: Sam’s long-haired white cat
